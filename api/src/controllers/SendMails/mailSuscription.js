...
function mailSuscription(){
  ...
  <body>
    <div>
      ...
      <h1 class="main-title">Notificacion de suscripción</h1>
      <center><span>Hola, agradecemos tu suscripcion a Techcommerce, esperamos que disfrutes de nuestra variedad de productos</span></center>
      <div class="status">
        <img src="https://www.impactplus.com/hubfs/15%20Brands%20Using%20Subscribe%20Pages%20to%20Attract%20Blog%20Subscribers.jpg" alt="status" />
        <article class="status-article">
          <br>
          <a class="btn__" href="${SERVER}">Visitar Página</a>
        </article>
      </div>
